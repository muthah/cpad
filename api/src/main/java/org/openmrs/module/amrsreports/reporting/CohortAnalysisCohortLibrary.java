...
/**
 * Cohort Analysis related cohort
 */
@Component
public class CohortAnalysisCohortLibrary {

   public CohortDefinition genericCohortDefinition(CohortDefinition cohortDefinition) {
