 ...
 */
@Handler(supports = {PatientsOnADayCohortDefinition.class})
public class PatientsOnADayCohortDefinitionEvaluator implements CohortDefinitionEvaluator {
    ...
    public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) throws EvaluationException {
        ...
        PatientsOnADayCohortDefinition definition = (PatientsOnADayCohortDefinition) cohortDefinition;
