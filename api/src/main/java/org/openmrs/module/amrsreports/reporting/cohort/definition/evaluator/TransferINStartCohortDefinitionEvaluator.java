 ...
 */
@Handler(supports = {TransferINStartCohortDefinition.class})
public class TransferINStartCohortDefinitionEvaluator implements CohortDefinitionEvaluator {
    ...
    public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) throws EvaluationException {
        ...
        TransferINStartCohortDefinition definition = (TransferINStartCohortDefinition) cohortDefinition;
